...
Befor eyou make the object you can check the read sizes of the duplexes and the transcripts that exist within the dataset using the `rnaCrosslinkQC` method. 

```{r}
rnaCrosslinkQC(sampleTable2,directory = tempfile())
